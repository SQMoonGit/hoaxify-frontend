...
describe("UserSignupPage", () => {
  ...
  describe("Interactions", () => {
    ...
    const setupForSubmit = (props) => {
      const rendered = render(<UserSignupPage {...props}></UserSignupPage>);
    ...
    it("disables the signup button when password and repeat password does not match to password", () => {
      setupForSubmit();
      ...
      const actions = {
        postSignup: jest.fn().mockRejectedValue({
          response: {
            data: {
              validationErrors: {
                password: "Username cannot be null",
              },
            },
          },
        }),
